...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default="coco128_test.yaml", help="dataset.yaml path")
    ...
    parser.add_argument("--project", default=ROOT_DEMO1 / "runs/train", help="save to project/name")
